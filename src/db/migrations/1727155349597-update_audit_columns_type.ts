...
export class UpdateAuditColumnsType1727155349597 implements MigrationInterface {
    name = 'UpdateAuditColumnsType1727155349597'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Categories\` ADD \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Cages\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`Cages\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`Cages\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`Cages\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`Counters\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`Counters\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`Counters\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`Counters\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`Categories\` DROP COLUMN \`updated_at\``);
        ...
        await queryRunner.query(`ALTER TABLE \`Credentials\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`Credentials\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`Credentials\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`Credentials\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    }
